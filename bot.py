...
TOKEN = os.environ.get("BOT_TOKEN", "8414661576:AAFBFISJ68syM-DdVWenDM1Q7CIyzSVQyaE")
...
def main():
    ...
    if external_url:
        print(f"Bot iniciado con webhook en {external_url}...")
        app.run_webhook(
            listen="0.0.0.0",
            port=port,
            url_path=TOKEN,
        ...
        print("Bot iniciado con polling (modo local)...")
